...
window = tk.Tk()
window.title("Attendify-Face Recognition Based Attendance Management System")
...
def manually_fill():
    ...
    def fill_attendance():
        ...
        try:
            global cursor
            connection = pymysql.connect(host='localhost', user='root', password='Ank@260201', db='ams_details')
        ...
        if subb=='':
            ...
            def create_csv():
                ...
                csv_name='C:/VS Code Projects/Attendace_management_system/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import os
                file_path = r"C:/VS Code Projects/Attendace_management_system/Attendance/Manually Attendance/"
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                try:
                    global cursor
                    connection = pymysql.connect(host='localhost', user='root', password='Ank@260201', db='Face_reco_fill')
                    cursor = connection.cursor()
                except Exception as e:
                    print(e)
                ...
                root.configure(background='snow')
                cs = 'C:/VS Code Projects/Attendace_management_system/' + fileName
    ...
    def Attf():
        import os
        file_path = r"C:/VS Code Projects/Attendace_management_system/Attendance/"
        os.startfile(file_path)
    ...
    def log_in():
        ...
        if username == 'Ankan_gh' :
            if password == 'Test@123':
                ...
                cs = 'C:/VS Code Projects/Attendace_management_system/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
